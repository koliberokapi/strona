...
public class Const {
    ...
    public final static Triple<String, String, String> USER_MWO = Triple.of("mwo", "mwo@gmail.com", "mwo123");
    public final static Triple<String, String, String> USER_MANIEK = Triple.of("Maniek", "maniek@gmail.com", "maniek123");
    public final static Triple<String, String, String> USER_DIEGO = Triple.of("diego", "diego@gmail.com", "diego123");
    public final static Triple<String, String, String> USER_NONEXISTENT = Triple.of("Piotr", "piotr@gmail.com", "piotr123");
